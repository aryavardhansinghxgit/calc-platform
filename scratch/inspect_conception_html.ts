...
const htmlPath = path.resolve(process.cwd(), ".next/server/app/calculators/conception-calculator.html");
if (fs.existsSync(htmlPath)) {
  const html = fs.readFileSync(htmlPath, "utf-8");

  console.log("=== HTML INSPECTION: /calculators/conception-calculator ===");
  // Title
  ...
  console.log("FAQ Headings Count in DOM: ", faqHeadingCount);

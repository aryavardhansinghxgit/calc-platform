...
async function runAudit() {
  console.log("Fetching http://localhost:3000/calculators/protein-calculator...\n");
  const html = await fetchUrl("http://localhost:3000/calculators/protein-calculator");

  console.log("==================================================");
  console.log("DOM & SEO FORENSIC AUDIT — PROTEIN CALCULATOR");
  console.log("==================================================");

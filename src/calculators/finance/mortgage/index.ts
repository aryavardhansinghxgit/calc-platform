...
export const MORTGAGE_CALCULATOR: CalculatorModuleDefinition = {
  ...
  iconName: "Home",
  featured: true,
  tags: ["mortgage", "home loan", "interest", "real estate", "property tax"],
  ...
  faqs: [
    {
      ...
      answer: "Your monthly payment consists of Principal & Interest (calculated via loan amount, interest rate, and term), plus estimated Property Tax, Home Insurance, and HOA fees.",
    },
    {
      question: "How does making extra payments affect my mortgage?",
      answer: "Extra monthly payments go directly toward reducing your principal balance, which significantly decreases total interest paid and shortens your payoff date.",
    },
    {
      question: "What is a good down payment percentage?",
      answer: "Standard down payments range from 3% to 20%. Putting down 20% or more eliminates Private Mortgage Insurance (PMI) requirements.",
    },
  ],
  inputs: [
    {

...
export const SEARCH_INDEX: SearchIndexItem[] = [
  ...
  },
  {
    ...
    category: "Finance",
    keywords: ["auto loan", "car loan", "vehicle financing", "monthly payment", "sales tax", "trade in", "car payment"],
  ...
  },
  {
    ...
    category: "Finance",
    keywords: ["loan", "personal loan", "borrowing cost", "monthly payment"],

    ...
    <div className="border-b-2 border-zinc-900 pb-4 mb-6 flex items-start justify-between">
      <div className="space-y-1">
        <div className="flex items-center gap-2">
          <div className="h-7 w-7 rounded-lg bg-zinc-900 text-white font-extrabold flex items-center justify-center text-sm tracking-tight">
            C
          </div>
        ...
        <h1 className="text-xl font-extrabold uppercase text-zinc-900 tracking-wide mt-2">

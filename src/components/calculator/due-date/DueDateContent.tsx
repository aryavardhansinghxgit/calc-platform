    ...
    <article className="prose prose-zinc dark:prose-invert max-w-none space-y-10 text-zinc-700 dark:text-zinc-300 leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 text-xs">
          ...
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-purple-600 dark:text-purple-400">2. Cycle-Adjusted Parikh's Formula</span>
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed">
          ...
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-emerald-600 dark:text-emerald-400">3. Mittendorf-Williams Rule (Parity Adjustment)</span>
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed">
        ...
        <div className="overflow-x-auto rounded-xl border border-zinc-200 dark:border-zinc-800">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
              <tr>
                <td className="p-3 font-semibold text-amber-600">Preterm</td>
              ...
              <tr>
                <td className="p-3 font-semibold text-cyan-600">Early Term</td>
              ...
              <tr>
                <td className="p-3 font-semibold text-emerald-600">Full Term</td>
                <td className="p-3">39 Weeks 0 Days – 40 Weeks 6 Days</td>
                <td className="p-3 font-bold text-emerald-600">~57%</td>
                <td className="p-3">Optimal neonatal outcomes; lowest morbidity.</td>
              </tr>
              <tr>
                <td className="p-3 font-semibold text-purple-600">Late Term</td>

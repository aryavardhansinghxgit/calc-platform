    ...
    <article className="prose dark:prose-invert max-w-none space-y-12 text-zinc-700 dark:text-zinc-300 leading-relaxed text-sm">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
          ...
          <div className="p-4 rounded-xl bg-amber-50/70 dark:bg-amber-950/30 border border-amber-100 dark:border-amber-900/40 space-y-2">
            <h3 className="text-sm font-bold text-amber-900 dark:text-amber-300 flex items-center gap-1.5">
              <AlertTriangle className="h-4 w-4 text-amber-500" /> Simple Interest for Investors
            </h3>
            <p className="text-xs text-zinc-600 dark:text-zinc-400">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Percent className="h-6 w-6 text-indigo-600" /> Simple Interest Formula
        </h2>
        ...
        <div className="p-5 rounded-xl bg-zinc-900 text-white font-sans tabular-nums space-y-3 shadow-md my-4">
          ...
          <span className="text-xs text-indigo-400 font-bold uppercase tracking-wider block pt-2 border-t border-zinc-800">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Clock className="h-6 w-6 text-indigo-600" /> How Simple Interest Works: Step-by-Step Walkthrough
        </h2>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Zap className="h-6 w-6 text-amber-500" /> Simple Interest for Different Frequencies (Years, Months, Weeks, Days)
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-sans tabular-nums my-3">
          <div className="p-3.5 rounded-lg bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
            ...
            <p className="font-sans text-[11px] text-zinc-500">Example: 18 months = 18/12 = 1.5 years</p>
          </div>

          <div className="p-3.5 rounded-lg bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
            <span className="font-bold font-sans text-zinc-800 dark:text-zinc-200 block">2. Weekly Term (w weeks)</span>
            <div className="text-indigo-600 dark:text-indigo-400 font-bold">t = w / 52</div>
            <p className="font-sans text-[11px] text-zinc-500">Example: 26 weeks = 26/52 = 0.5 years</p>
          </div>
          ...
          <div className="p-3.5 rounded-lg bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1 sm:col-span-2">
            ...
            <div className="text-indigo-600 dark:text-indigo-400 font-bold">t = d / 365</div>
            <p className="font-sans text-[11px] text-zinc-500">Example: 90 days = 90/365 = 0.24657 years</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        ...
        <div className="space-y-3 text-xs">
          ...
          <div className="p-4 rounded-xl bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/40 space-y-1">
            <h3 className="font-bold text-emerald-900 dark:text-emerald-300 text-sm">Example 2: Auto Loan Interest</h3>
            <p className="text-zinc-600 dark:text-zinc-400">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <ShieldCheck className="h-6 w-6 text-emerald-600" /> What Financial Instruments Use Simple Interest?
        </h2>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Scale className="h-6 w-6 text-purple-600" /> Simple Interest vs. Compound Interest Comparison
        </h2>
          ...
          <table className="w-full text-xs text-left">
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
              ...
              <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                ...
                <td className="p-3 font-bold text-emerald-600">Exponential (accelerating annual dollars)</td>
              </tr>
              <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                <td className="p-3 font-bold">Investment Returns</td>
                <td className="p-3">Lower long-term accumulated wealth</td>
                <td className="p-3 font-bold text-emerald-600">Substantially higher long-term wealth</td>
              </tr>
              <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                ...
                <td className="p-3 text-rose-600">Higher total interest cost if unpaid</td>
              </tr>
            </tbody>
          </table>
        </div>

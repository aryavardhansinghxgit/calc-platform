        ...
        <div className="overflow-x-auto rounded-xl border border-zinc-200 dark:border-zinc-800">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
              ...
              <tr>
                <td className="p-3 font-semibold text-emerald-600 dark:text-emerald-400">Normal Weight</td>
              ...
              <tr>
                <td className="p-3 font-semibold text-amber-600 dark:text-amber-400">Overweight</td>
              ...
              <tr>
                <td className="p-3 font-semibold text-purple-600 dark:text-purple-400">Obese</td>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            ...
            <p className="text-zinc-500 dark:text-zinc-400">Average full-term infant weight at delivery.</p>
          </div>
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-purple-600 dark:text-purple-400">Placenta: 1.5 lbs (0.7 kg)</span>
            <p className="text-zinc-500 dark:text-zinc-400">Vascular organ supplying oxygen and nutrient transfer.</p>
          </div>
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-cyan-600 dark:text-cyan-400">Amniotic Fluid: 2.0 lbs (0.9 kg)</span>
            <p className="text-zinc-500 dark:text-zinc-400">Protective cushioning liquid surrounding baby.</p>
          </div>
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-blue-600 dark:text-blue-400">Uterine Expansion: 2.0 lbs (0.9 kg)</span>
            <p className="text-zinc-500 dark:text-zinc-400">Hypertrophy of uterine smooth muscle tissue.</p>
          </div>
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-red-600 dark:text-red-400">Maternal Blood Volume: 4.0 lbs (1.8 kg)</span>
            <p className="text-zinc-500 dark:text-zinc-400">50% increase in circulating blood plasma volume.</p>
          </div>
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-emerald-600 dark:text-emerald-400">Extracellular Fluids: 3.0 lbs (1.4 kg)</span>
            <p className="text-zinc-500 dark:text-zinc-400">Increased tissue fluid and cellular hydration.</p>
          </div>
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-amber-600 dark:text-amber-400">Breast Tissue: 2.0 lbs (0.9 kg)</span>
            <p className="text-zinc-500 dark:text-zinc-400">Mammary gland development for breastfeeding preparation.</p>
          </div>
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-indigo-600 dark:text-indigo-400">Fat & Nutrient Stores: 7.0 lbs (3.2 kg)</span>
            <p className="text-zinc-500 dark:text-zinc-400">Energy reserve required for labor and early lactation.</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-xl border border-amber-500/20 bg-amber-500/5 space-y-2">
            <h3 className="font-bold text-amber-800 dark:text-amber-300 text-sm m-0">

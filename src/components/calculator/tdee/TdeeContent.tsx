      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-10">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-cyan-600">1–2.</span> What Is TDEE & Why Does It Matter?
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
          <div className="bg-cyan-50/80 p-5 rounded-2xl border border-cyan-200/80 space-y-2">
        ...
        <div className="space-y-4 pt-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-cyan-600">8–9.</span> Physical Activity Level (PAL) Multipliers
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
            ...
            <table className="w-full text-left text-xs md:text-sm text-slate-700">
              ...
              <tbody className="divide-y divide-slate-200">
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3.5 font-bold text-cyan-700">1.20</td>
                ...
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3.5 font-bold text-cyan-700">1.375</td>
                ...
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3.5 font-bold text-cyan-700">1.55</td>
                ...
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3.5 font-bold text-cyan-700">1.725</td>
                ...
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3.5 font-bold text-cyan-700">2.10</td>
      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-xs text-slate-500 mt-1">Basal metabolic rate equations.</p>
          </Link>

...
export function InterestContent() {
  return (
    <article className="prose dark:prose-invert max-w-none space-y-12 text-zinc-700 dark:text-zinc-300 leading-relaxed text-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
          ...
          <div className="p-4 rounded-xl bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/40 space-y-2">
            <h3 className="text-sm font-bold text-emerald-900 dark:text-emerald-300 flex items-center gap-1.5">
              <Award className="h-4 w-4 text-emerald-500" /> Interest for Investors
            </h3>
            <p className="text-xs text-zinc-600 dark:text-zinc-400">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Percent className="h-6 w-6 text-indigo-600" /> Understanding Simple Interest
        </h2>
        ...
        <div className="p-5 rounded-xl bg-zinc-900 text-white font-mono space-y-2 shadow-md my-4">
          ...
          <div className="text-xs text-zinc-400 pt-2 border-t border-zinc-800 grid grid-cols-2 gap-2">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Zap className="h-6 w-6 text-emerald-600" /> Understanding Compound Interest
        </h2>
        ...
        <div className="p-5 rounded-xl bg-zinc-900 text-white font-mono space-y-3 shadow-md my-4">
          ...
          <div className="text-lg sm:text-xl font-black text-indigo-400 border-t border-zinc-800 pt-2">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Scale className="h-6 w-6 text-purple-600" /> Simple Interest vs. Compound Interest
        </h2>
          ...
          <table className="w-full text-xs text-left">
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
              ...
              <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                ...
                <td className="p-3 font-bold text-emerald-600">Exponential (Accelerating)</td>
              </tr>
              <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                <td className="p-3 font-bold">Investor Returns</td>
                <td className="p-3">Modest long-term growth</td>
                <td className="p-3 font-bold text-emerald-600">Maximized exponential wealth</td>
              </tr>
              <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                <td className="p-3 font-bold">Borrower Costs</td>
                <td className="p-3 font-bold text-blue-600">Cheaper for loans</td>
                <td className="p-3 text-rose-600">Higher borrowing cost if unpaid</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs my-3">
          <div className="p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800">
            ...
            <span className="text-zinc-500 text-[11px]">Compounded once per year. Standard for long-term bonds.</span>
          </div>

          <div className="p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800">
            <strong className="text-zinc-900 dark:text-zinc-100 block">Semi-Annual (n = 2)</strong>
            <span className="text-zinc-500 text-[11px]">Compounded twice a year. Typical for U.S. Treasury Notes.</span>
          </div>

          <div className="p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800">
            <strong className="text-zinc-900 dark:text-zinc-100 block">Quarterly (n = 4)</strong>
            <span className="text-zinc-500 text-[11px]">Compounded 4 times a year. Standard for dividend stocks & CDs.</span>
          </div>

          <div className="p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800">
            <strong className="text-zinc-900 dark:text-zinc-100 block">Monthly (n = 12)</strong>
            <span className="text-zinc-500 text-[11px]">Compounded 12 times a year. Standard for savings accounts & loans.</span>
          </div>

          <div className="p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800">
            <strong className="text-zinc-900 dark:text-zinc-100 block">Daily (n = 365)</strong>
            <span className="text-zinc-500 text-[11px]">Compounded every single day. Maximum standard bank compounding.</span>
          </div>

          <div className="p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800">
            <strong className="text-zinc-900 dark:text-zinc-100 block">Continuous (n = &infin;)</strong>
            <span className="text-zinc-500 text-[11px]">Compounded infinitely using Euler's number e &approx; 2.71828.</span>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Clock className="h-6 w-6 text-amber-500" /> The Rule of 72
        </h2>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <Flame className="h-6 w-6 text-rose-500" /> Inflation and Interest: Real Purchasing Power
        </h2>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <ShieldCheck className="h-6 w-6 text-emerald-600" /> Taxation of Interest Income
        </h2>
      ...
      <section className="space-y-6 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3">
          <HelpCircle className="h-6 w-6 text-indigo-600" /> Frequently Asked Questions (12+ FAQs)
        </h2>

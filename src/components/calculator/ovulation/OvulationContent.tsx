      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-2">
            ...
            <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed m-0">
          ...
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-2">
            <span className="font-bold text-emerald-600 uppercase text-[10px] tracking-wider">
          ...
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-2">
            <span className="font-bold text-purple-600 uppercase text-[10px] tracking-wider">
        ...
        <div className="overflow-x-auto rounded-xl border border-zinc-200 dark:border-zinc-800">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
              ...
              <tr>
                <td className="p-3 font-semibold text-purple-600">2 Days Before (O-2)</td>
                <td className="p-3 text-purple-600 font-bold">Peak</td>
                <td className="p-3 font-bold text-purple-600">~27%</td>
                <td className="p-3 font-semibold">One of the two most fertile days of the cycle.</td>
              </tr>
              <tr>
                <td className="p-3 font-semibold text-purple-600">1 Day Before (O-1)</td>
                <td className="p-3 text-purple-600 font-bold">Peak</td>
              ...
              <tr>
                ...
                <td className="p-3 text-zinc-500 font-semibold">Low</td>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 text-xs">
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed m-0">
          ...
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-purple-600 dark:text-purple-400">2. Ovulation Predictor Kits (LH Surge Tests)</span>
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed m-0">
          ...
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-emerald-600 dark:text-emerald-400">3. Cervical Mucus Monitoring (Billing Method)</span>
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed m-0">

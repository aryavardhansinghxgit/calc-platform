...
import { EmiAmortizationRow } from "@/modules/emi/types";
import { formatCurrency, formatCompactNumber } from "@/lib/calculator-engine/formatters";

export interface EmiBalanceLineChartProps {
  schedule: EmiAmortizationRow[];
}

export function EmiBalanceLineChart({ schedule }: EmiBalanceLineChartProps) {
...
export default EmiBalanceLineChart;

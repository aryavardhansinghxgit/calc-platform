...
export function ZScoreCalculator() {
  ...
  const renderBellCurve = (targetZ: number, shadedMode: "left" | "right" | "two" | "interval", z2: number = 0) => {
    ...
    const xPosTarget = scaleX(targetZ);
    const xPosTarget2 = scaleX(z2);
    ...
    return (
      <svg viewBox="0 0 500 150" className="w-full max-w-xl h-auto">
        ...
        {/* Primary Target Z Vertical Indicator Line (Solid Blue) */}
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 space-y-4 shadow-xs">
              ...
              <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl text-xs font-bold">
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg cursor-pointer transition-all ${
                    activeTail1 === "left" ? "bg-blue-600 text-white shadow-xs" : "text-slate-700 dark:text-slate-300"
                  }`}
                >
                  Shade Left Tail
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg cursor-pointer transition-all ${
                    activeTail1 === "right" ? "bg-blue-600 text-white shadow-xs" : "text-slate-700 dark:text-slate-300"
                  }`}
                >
                  Shade Right Tail
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg cursor-pointer transition-all ${
                    activeTail1 === "two" ? "bg-blue-600 text-white shadow-xs" : "text-slate-700 dark:text-slate-300"
                  }`}
                >
                  Shade Two Tails
                </button>
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700 font-mono text-xs space-y-1">
              <span className="font-bold text-blue-600 dark:text-blue-400 block font-sans text-xs">Step-by-Step Substitution Formula:</span>
              <p>{stdResult.stepText}</p>
            </div>
          </div>
                ...
                <div className="grid grid-cols-2 gap-2 pt-1">
                  <div>
                    ...
                    <input
                      ...
                      step="any"
                      value={invMean}
                      onChange={(e) => setInvMean(parseFloat(e.target.value) || 0)}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="any"
                      value={invSD}
                      onChange={(e) => setInvSD(parseFloat(e.target.value) || 1)}
                      className="w-full h-9 px-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 font-mono font-bold text-xs"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      step="any"
                      value={intX1}
                      onChange={(e) => setIntX1(parseFloat(e.target.value) || 0)}
                      className="w-full h-9 px-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 font-mono font-bold text-xs"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="any"
                      value={intX2}
                      onChange={(e) => setIntX2(parseFloat(e.target.value) || 0)}
                      className="w-full h-9 px-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 font-mono font-bold text-xs"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      step="any"
                      value={intMean}
                      onChange={(e) => setIntMean(parseFloat(e.target.value) || 0)}
                      className="w-full h-9 px-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 font-mono font-bold text-xs"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="any"
                      value={intSD}
                      onChange={(e) => setIntSD(parseFloat(e.target.value) || 1)}
                      className="w-full h-9 px-2 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 font-mono font-bold text-xs"
                    />
                  </div>
                </div>

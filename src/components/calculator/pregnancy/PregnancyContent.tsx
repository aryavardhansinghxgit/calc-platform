    ...
    <article className="prose prose-zinc dark:prose-invert max-w-none space-y-10 my-10 text-zinc-800 dark:text-zinc-200 leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <div className="overflow-x-auto my-4">
          <table className="w-full text-sm border-collapse border border-zinc-200 dark:border-zinc-800">
            ...
            <tbody>
              <tr>
                <td className="border border-zinc-200 dark:border-zinc-700 p-2.5 font-semibold text-rose-600">Preterm</td>
              ...
              <tr>
                <td className="border border-zinc-200 dark:border-zinc-700 p-2.5 font-semibold text-amber-600">Early Term</td>
              ...
              <tr>
                <td className="border border-zinc-200 dark:border-zinc-700 p-2.5 font-semibold text-emerald-600">Full Term</td>
              ...
              <tr>
                <td className="border border-zinc-200 dark:border-zinc-700 p-2.5 font-semibold text-purple-600">Postterm</td>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 space-y-2">
            <h4 className="font-bold text-rose-600 dark:text-rose-400 text-sm">Naegele's Rule & LMP Method</h4>
            <p className="text-xs">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 space-y-2">
            <h4 className="font-bold text-rose-600 dark:text-rose-400 text-sm">Conception Date Method</h4>
            <p className="text-xs">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 space-y-2">
            <h4 className="font-bold text-rose-600 dark:text-rose-400 text-sm">Ultrasound Dating (Crown-Rump Length)</h4>
            <p className="text-xs">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 space-y-2">
            <h4 className="font-bold text-rose-600 dark:text-rose-400 text-sm">IVF Embryo Transfer Calculation</h4>
            <p className="text-xs">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 text-sm">
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-rose-50/40 dark:bg-rose-950/20">
            <h4 className="font-bold text-rose-700 dark:text-rose-300">First Trimester (Weeks 1–13)</h4>
          ...
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-emerald-50/40 dark:bg-emerald-950/20">
            <h4 className="font-bold text-emerald-700 dark:text-emerald-300">Second Trimester (Weeks 14–27)</h4>
            <p className="text-xs mt-1">
          ...
          <table className="w-full text-xs border-collapse border border-zinc-200 dark:border-zinc-800">
            ...
            <tbody>
              <tr>
                ...
                <td className="border p-2 text-rose-600 font-bold">28 – 40 lbs (12.5–18 kg)</td>
              ...
              <tr>
                ...
                <td className="border p-2 text-emerald-600 font-bold">25 – 35 lbs (11.5–16 kg)</td>
              ...
              <tr>
                ...
                <td className="border p-2 text-amber-600 font-bold">15 – 25 lbs (7–11.5 kg)</td>
              ...
              <tr>
                ...
                <td className="border p-2 text-purple-600 font-bold">11 – 20 lbs (5–9 kg)</td>
      ...
      <section className="space-y-4">
        ...
        <div className="overflow-x-auto my-4">
          <table className="w-full text-xs border-collapse border border-zinc-200 dark:border-zinc-800">
            ...
            <tbody>
              <tr>
                <td className="border p-2 font-bold text-emerald-600">Category A</td>
              ...
              <tr>
                <td className="border p-2 font-bold text-emerald-700">Category B</td>
              ...
              <tr>
                <td className="border p-2 font-bold text-amber-600">Category C</td>
              ...
              <tr>
                <td className="border p-2 font-bold text-rose-600">Category X</td>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
          <Link
            ...
            className="p-3 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:border-rose-400 transition-all font-semibold text-rose-600 dark:text-rose-400 block"
          >
            Due Date Calculator →
          </Link>
          <Link

                    ...
                    <table className="w-full text-left text-xs font-mono">
                      <thead>
                        <tr className="border-b border-slate-200 dark:border-slate-700 text-slate-500 font-sans font-bold uppercase text-[9px]">
                          ...
                          <th className="py-1 px-1.5">Principal Depr</th>
                          <th className="py-1 px-1.5">Interest Charge</th>
                      ...
                      <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-[11px]">
                        {currentSchedulePage.map((row) => (
                          <tr key={row.month} className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                            ...
                            <td className="py-1 px-1.5 text-blue-600 font-bold">{fmt(row.principalDepreciation)}</td>
                            <td className="py-1 px-1.5 text-amber-600">{fmt(row.interestFinanceCharge)}</td>

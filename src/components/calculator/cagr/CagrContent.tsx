          ...
          <table className="w-full text-left border-collapse border border-zinc-200 dark:border-zinc-800 text-[11px]">
            <thead>
              <tr className="bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100">
                ...
                <th className="p-2.5 border border-zinc-200 dark:border-zinc-700 font-bold text-amber-600 dark:text-amber-400">Absolute Return</th>
                <th className="p-2.5 border border-zinc-200 dark:border-zinc-700 font-bold text-emerald-600 dark:text-emerald-400">IRR / XIRR</th>
              </tr>
            </thead>

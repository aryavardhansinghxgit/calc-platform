            ...
            <table className="w-full text-left text-xs md:text-sm text-slate-700">
              ...
              <tbody className="">
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5 font-bold text-blue-600">46.1%</td>
                ...
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5 font-bold text-blue-600">20.9%</td>
                ...
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5">Bust - Hips ≥ 3.6" &amp; Bust-Waist &lt; 9"</td>
                  <td className="p-3.5 font-bold text-blue-600">13.8%</td>
                ...
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5 font-bold text-blue-600">8.4%</td>

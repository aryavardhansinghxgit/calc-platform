      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-10">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-cyan-600">1–2.</span> What Are Carbohydrates & Why Do They Matter?
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
            <strong className="text-slate-900">Carbohydrates</strong> are organic biomolecules composed of carbon, hydrogen, and oxygen atoms ($C_n(H_2O)_n$). They are the body&apos;s principal energy source, digested into <strong className="text-cyan-700">glucose</strong> to fuel brain function, central nervous system activity, and muscular exercise.
          </p>
        </div>
        ...
        <div className="space-y-4 pt-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-cyan-600">14–16.</span> Glycemic Index (GI), Glycemic Load (GL) & Net Carbs
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
        ...
        <div className="space-y-4 pt-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-cyan-600">24.</span> Carbohydrate & Glycemic Reference Values
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
            ...
            <table className="w-full text-left text-xs md:text-sm text-slate-700">
              ...
              <tbody className="divide-y divide-slate-200">
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3 font-bold text-cyan-700">19.1g</td>
                  <td className="p-3 font-bold text-emerald-700">3.3g</td>
                ...
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3 font-bold text-cyan-700">27.0g</td>
                  <td className="p-3 font-bold text-emerald-700">3.1g</td>
                ...
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3 font-bold text-cyan-700">28.1g</td>
                  <td className="p-3 font-bold text-emerald-700">4.0g</td>
                ...
                <tr className="hover:bg-cyan-50/40">
                  ...
                  <td className="p-3 font-bold text-cyan-700">40.8g</td>
                  <td className="p-3 font-bold text-emerald-700">15.0g</td>
      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-xs text-slate-500 mt-1">Protein targets for muscle.</p>
          </Link>

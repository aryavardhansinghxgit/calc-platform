            ...
            <div className="md:col-span-7 space-y-4">
              <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-xs space-y-4">
                <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 space-y-2">
                  ...
                  <div className={`text-4xl font-mono font-extrabold ${targetResult.isAchievable ? "text-emerald-600" : "text-amber-600"}`}>
                    {targetResult.neededScore}%
                  </div>
                  <p className="text-xs font-mono font-bold text-slate-500">
                    Status: {targetResult.isAchievable ? "Achievable" : "Requires >100% score"}
                  </p>
                </div>

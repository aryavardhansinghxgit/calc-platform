      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 my-4 text-xs">
          <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 space-y-1">
            <h4 className="font-extrabold text-blue-600 dark:text-blue-400 text-sm">Solute</h4>
            <p className="leading-relaxed">
          ...
          <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 space-y-1">
            <h4 className="font-extrabold text-blue-600 dark:text-blue-400 text-sm">Solution</h4>
            <p className="leading-relaxed">
      ...
      <section className="space-y-4  dark:border-zinc-800 pt-6">
        ...
        <div className="space-y-3 my-4">
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 font-sans tabular-nums text-xs space-y-1">
            <span className="text-slate-900 font-bold block text-[10px] uppercase">1. Primary Molarity Equation:</span>
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 font-sans tabular-nums text-xs space-y-1">
            <span className="text-slate-900 font-bold block text-[10px] uppercase">2. Solute Mass Preparation Equation:</span>
            <div className="text-blue-600 dark:text-blue-400 font-extrabold text-sm">
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 font-sans tabular-nums text-xs space-y-1">
            <span className="text-slate-900 font-bold block text-[10px] uppercase">3. Stock Dilution Law Equation:</span>
            <div className="text-blue-600 dark:text-blue-400 font-extrabold text-sm">
              C₁ · V₁ = C₂ · V₂   or   M₁ · V₁ = M₂ · V₂
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 font-sans tabular-nums text-xs space-y-1">
            <span className="text-slate-900 font-bold block text-[10px] uppercase">4. Mass Percentage to Molarity Conversion:</span>
            <div className="text-blue-600 dark:text-blue-400 font-extrabold text-sm">
        ...
        <div className="overflow-x-auto my-4">
          <table className="w-full text-xs text-left border-collapse border border-slate-200 dark:border-zinc-800">
            ...
            <tbody className="font-sans tabular-nums">
              <tr>
                <td className="p-2 border border-slate-200 dark:border-zinc-800 font-bold text-blue-600">Molarity</td>
                ...
                <td className="p-2 border border-slate-200 dark:border-zinc-800 text-blue-600 font-bold">Yes (Volumetric expansion)</td>
              </tr>
              <tr>
                ...
                <td className="p-2 border border-slate-200 dark:border-zinc-800 text-blue-600 font-bold">No (Mass invariant)</td>
              </tr>
              <tr>
                <td className="p-2 border border-slate-200 dark:border-zinc-800 font-bold text-blue-600">Normality</td>
                ...
                <td className="p-2 border border-slate-200 dark:border-zinc-800 text-blue-600 font-bold">Yes</td>
              </tr>
              <tr>
                <td className="p-2 border border-slate-200 dark:border-zinc-800 font-bold text-blue-600">Mass Concentration</td>
              ...
              <tr>
                <td className="p-2 border border-slate-200 dark:border-zinc-800 font-bold text-blue-600">Parts Per Million</td>
      ...
      <section className="space-y-4  dark:border-zinc-800 pt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs my-4">
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 space-y-2">
            <h4 className="font-extrabold text-blue-600 dark:text-blue-400 text-sm">Volumetric Expansion &amp; Order of Mixing</h4>
            <p className="leading-relaxed">
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-800/80 border border-slate-200 dark:border-zinc-700 space-y-2">
            <h4 className="font-extrabold text-blue-600 dark:text-blue-400 text-sm">The &quot;Acid to Water&quot; Safety Rule</h4>
            <p className="leading-relaxed">
          ...
          <table className="w-full text-xs text-left border-collapse border border-slate-200 dark:border-zinc-800 font-sans tabular-nums">
            ...
            <tbody>
              <tr>
                ...
                <td className="p-2 border border-slate-200 dark:border-zinc-800 text-blue-600 font-bold">12.1 M</td>
              </tr>
              <tr>
                ...
                <td className="p-2 border border-slate-200 dark:border-zinc-800 text-blue-600 font-bold">18.0 M (36.0 N)</td>
              </tr>
              <tr>
                ...
                <td className="p-2 border border-slate-200 dark:border-zinc-800 text-blue-600 font-bold">15.8 M</td>
              </tr>
              <tr>
                ...
                <td className="p-2 border border-slate-200 dark:border-zinc-800 text-blue-600 font-bold">17.4 M</td>
              </tr>
            </tbody>
          </table>
        </div>

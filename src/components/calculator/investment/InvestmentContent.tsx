  ...
  return (
    <article className="prose dark:prose-invert max-w-none space-y-12 text-zinc-700 dark:text-zinc-300 leading-relaxed text-sm">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-blue-600 dark:text-blue-400 flex items-center gap-2  dark:border-zinc-800 pb-3">What Is Investing & Why It Matters
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4 text-xs">
          <div className="p-4 rounded-xl bg-blue-50/70 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/40 space-y-2">
            <h3 className="text-sm font-bold text-blue-900 dark:text-blue-300 flex items-center gap-1.5">Inflation Protection
            </h3>
          ...
          <div className="p-4 rounded-xl bg-blue-50/70 dark:bg-blue-50/30 border border-emerald-100 dark:border-emerald-900/40 space-y-2">
            <h3 className="text-sm font-bold text-emerald-900 dark:text-blue-400 flex items-center gap-1.5">Passive Income Generation
            </h3>
            <p className="text-slate-900 dark:text-slate-100">
      ...
      {/* ==========================================
         ...
         ========================================== */}
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-blue-600 dark:text-blue-400 flex items-center gap-2  dark:border-zinc-800 pb-3">The Power of Compound Growth & Time Horizon
        </h2>
        ...
        <div className="p-5 rounded-xl bg-blue-50/70 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-900/50 text-blue-700 dark:text-blue-400 font-sans tabular-nums space-y-3 shadow-md my-4">
          <span className="text-xs text-blue-400 font-bold uppercase tracking-wider block">Investment Future Value Formula</span>
          ...
          <div className="text-xs text-zinc-300 pt-2  grid grid-cols-2 gap-2 font-sans">
      ...
      {/* ==========================================
         ...
         ========================================== */}
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-blue-600 dark:text-blue-400 flex items-center gap-2  dark:border-zinc-800 pb-3">Different Asset Classes & Investment Types
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">1. Certificates of Deposit (CDs)</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">2. Government & Corporate Bonds</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">3. Equities & Stocks</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">4. Real Estate & REITs</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">5. Commodities & Gold</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 space-y-1">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">6. Index Funds & Low-Cost ETFs</h3>
            <p className="text-slate-900 dark:text-slate-100">
      ...
      {/* ==========================================
         ...
         ========================================== */}
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-blue-600 dark:text-blue-400 flex items-center gap-2  dark:border-zinc-800 pb-3">Inflation, Tax Rates & Expense Ratio Friction
        </h2>

        <div className="space-y-3 text-xs">
          <div className="p-4 rounded-xl bg-blue-50/60 dark:bg-blue-50/30 border border-rose-100 dark:border-rose-900/40 space-y-1">
            <h3 className="font-bold text-rose-900 dark:text-blue-400 text-sm">1. Inflation Drag</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-blue-50/60 dark:bg-blue-50/30 border border-amber-100 dark:border-amber-900/40 space-y-1">
            <h3 className="font-bold text-amber-900 dark:text-blue-400 text-sm">2. Management Fee Drag</h3>
            <p className="text-slate-900 dark:text-slate-100">
      ...
      <section className="space-y-6 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 space-y-1.5">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">1. What is a good annual investment return?</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 space-y-1.5">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">2. How much should I invest monthly?</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 space-y-1.5">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">3. What is dollar-cost averaging (DCA)?</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 space-y-1.5">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">4. Should I invest monthly or annually?</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 space-y-1.5">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">5. How does the FIRE number work?</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 space-y-1.5">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm">6. How does expense ratio impact portfolio growth?</h3>
            <p className="text-slate-900 dark:text-slate-100">

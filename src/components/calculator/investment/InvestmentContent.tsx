...
export function InvestmentContent() {
  return (
    <article className="prose dark:prose-invert max-w-none space-y-12 text-zinc-700 dark:text-zinc-300 leading-relaxed text-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4 text-xs">
          ...
          <div className="p-4 rounded-xl bg-blue-50/70 dark:bg-blue-50/30 border border-emerald-100 dark:border-emerald-900/40 space-y-2">
            <h3 className="text-sm font-bold text-emerald-900 dark:text-blue-400 flex items-center gap-1.5">
              <Award className="h-4 w-4 text-blue-600" /> Passive Income Generation
            </h3>
            <p className="text-slate-900 dark:text-slate-100">
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2  dark:border-zinc-800 pb-3">
          <Zap className="h-6 w-6 text-blue-600" /> The Power of Compound Growth & Time Horizon
        </h2>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2  dark:border-zinc-800 pb-3">
          <Layers className="h-6 w-6 text-blue-600" /> Different Asset Classes & Investment Types
        </h2>
      ...
      <section className="space-y-4 bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-xs">
        <h2 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-zinc-100 flex items-center gap-2  dark:border-zinc-800 pb-3">
          <Flame className="h-6 w-6 text-blue-600" /> Inflation, Tax Rates & Expense Ratio Friction
        </h2>

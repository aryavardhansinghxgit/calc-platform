...
export function CalculatorLayout({ definition }: CalculatorLayoutProps) {
  ...
  const isDayCounter = idLower === "day-counter-calculator" || slugLower === "day-counter-calculator";

            ...
            <div className="space-y-2.5 pt-3 border-t border-blue-200/60 dark:border-blue-900/40">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                ...
                <div className="p-2.5 sm:p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                  ...
                  <span className="text-sm sm:text-base font-bold text-slate-900 dark:text-white">
                    {activeTab === "crossdate" ? crossDateResult.totalSeconds.toLocaleString() : activeTab === "multisegment" ? multiSegmentResult.totalSeconds.toLocaleString() : sameDayResult.totalSeconds.toLocaleString()} s
                  </span>
                </div>
                ...
                <div className="p-2.5 sm:p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                  ...
                  <span className="text-sm sm:text-base font-bold text-indigo-600 dark:text-indigo-400">
                    {activeTab === "crossdate" ? `${(crossDateResult.totalDecimalDays * 100).toFixed(1)}%` : `${sameDayResult.percentOfDay}%`}
                  </span>
                </div>
              </div>
            </div>

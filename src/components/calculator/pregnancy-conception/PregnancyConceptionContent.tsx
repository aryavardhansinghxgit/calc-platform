    ...
    <article className="prose prose-zinc dark:prose-invert max-w-none space-y-10 text-zinc-700 dark:text-zinc-300 leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 text-xs">
          ...
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-blue-600 dark:text-blue-400">Phase 2: Luteal Surge & Ovulation (Mid-Cycle)</span>
            <p className="text-slate-900 dark:text-slate-100 leading-relaxed">
          ...
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-1">
            <span className="font-bold text-blue-600 dark:text-blue-400">Phase 3: Luteal Phase (Post-Ovulation to Period)</span>
            <p className="text-slate-900 dark:text-slate-100 leading-relaxed">
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className=" dark:divide-zinc-800">
              <tr>
                ...
                <td className="p-3 font-bold text-blue-600">~5%</td>
              ...
              <tr>
                ...
                <td className="p-3 font-bold text-blue-600">~12%</td>
              ...
              <tr>
                ...
                <td className="p-3 font-bold text-blue-600">~18%</td>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          ...
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 space-y-2">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 text-sm m-0">

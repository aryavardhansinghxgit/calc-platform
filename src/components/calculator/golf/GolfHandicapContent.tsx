  ...
  return (
    <article className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-8 py-2">
      ...
      <section className="space-y-3">
        ...
        <h3 className="text-base font-bold text-blue-600 dark:text-blue-400">WHS 1 to 20 Rounds Sliding Scale Lookup Table</h3>
        <p>
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
          <div className="p-3.5 bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 rounded-xl space-y-1">
            <h3 className="font-bold text-blue-600 dark:text-blue-400">Net Double Bogey Maximum</h3>
            <p className="text-slate-900 dark:text-slate-100">
          ...
          <div className="p-3.5 bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700 rounded-xl space-y-1">
            <h3 className="font-bold text-blue-600 dark:text-blue-400">Soft Cap & Hard Cap</h3>
            <p className="text-slate-900 dark:text-slate-100">

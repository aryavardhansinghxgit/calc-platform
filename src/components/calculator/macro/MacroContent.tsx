    ...
    <div className="w-full max-w-5xl mx-auto mt-16 space-y-12 text-slate-800 font-sans">
      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-10">
        <div className=" pb-6 flex items-center gap-3">
          <div className="p-3 bg-blue-50 text-blue-600 rounded-2xl border border-emerald-100">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-blue-600 flex items-center gap-2">
            <span className="text-blue-600">1–2.</span> What Are Macronutrients & Macro Calculators?
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
            <strong className="text-slate-900">Macronutrients</strong> (macros) are the foundational energy-yielding organic compounds that humans consume in large daily quantities to sustain life, repair muscle tissue, and fuel metabolic activity. The three primary macros are <strong className="text-blue-600">Protein</strong> (4 kcal/g), <strong className="text-blue-700">Carbohydrates</strong> (4 kcal/g), and <strong className="text-blue-600">Dietary Fats</strong> (9 kcal/g).
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
          <div className="bg-blue-50/80 p-6 rounded-2xl border border-emerald-200/80 space-y-3">
            <h4 className="font-bold text-emerald-950 text-base flex items-center gap-2">Protein (4 kcal/g)
            </h4>
          ...
          <div className="bg-blue-50/80 p-6 rounded-2xl border border-blue-200/80 space-y-3">
            <h4 className="font-bold text-blue-950 text-base flex items-center gap-2">Carbohydrates (4 kcal/g)
            </h4>
            <p className="text-xs md:text-sm text-slate-900 leading-relaxed">
          ...
          <div className="bg-blue-50/80 p-6 rounded-2xl border border-purple-200/80 space-y-3">
            <h4 className="font-bold text-purple-950 text-base flex items-center gap-2">Dietary Fat (9 kcal/g)
            </h4>
            <p className="text-xs md:text-sm text-slate-900 leading-relaxed">
        ...
        <div className="space-y-4 pt-4">
          <h3 className="text-xl font-bold text-blue-600 flex items-center gap-2">
            <span className="text-blue-600">10–11.</span> Clinical BMR & TDEE Equations
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
        ...
        <div className="space-y-4 pt-4">
          <h3 className="text-xl font-bold text-blue-600 flex items-center gap-2">
            <span className="text-blue-600">25.</span> Macronutrients in Common Foods
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
              ...
              >
                ...
                >
                  <span className="text-sm md:text-base flex items-center gap-2">
                    <span className="text-xs px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-600 border border-emerald-200 font-bold">
                      Q{idx + 1}
                    </span>
                    {faq.question}
                  </span>
      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-xs text-slate-900 mt-1">Estimate daily caloric expenditure.</p>
          </Link>
          ...
          >
            ...
            <p className="text-xs text-slate-900 mt-1">Calculate resting metabolic rate.</p>
          </Link>
          ...
          >
            ...
            <p className="text-xs text-slate-900 mt-1">Body mass index classification.</p>
          </Link>
          ...
          >
            ...
            <p className="text-xs text-slate-900 mt-1">Body composition assessment.</p>
          </Link>
          ...
          >
            ...
            <p className="text-xs text-slate-900 mt-1">Target healthy weight ranges.</p>
          </Link>
        </div>
      </section>

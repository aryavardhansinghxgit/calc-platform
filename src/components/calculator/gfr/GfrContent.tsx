            ...
            <table className="w-full text-left text-xs md:text-sm text-slate-700">
              ...
              <tbody className="">
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5 font-bold text-blue-600">≥ 90</td>
                ...
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5 font-bold text-blue-600">60 – 89</td>
                ...
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5 font-bold text-blue-600">45 – 59</td>
                ...
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5 font-bold text-blue-600">15 – 29</td>
                ...
                <tr className="hover:bg-blue-50/40">
                  ...
                  <td className="p-3.5 font-bold text-blue-600">&lt; 15</td>
      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-xs text-slate-900 mt-1">Body mass index evaluation.</p>
          </Link>
          ...
          >
            ...
            <p className="text-xs text-slate-900 mt-1">Devine, Robinson & Miller formulas.</p>
          </Link>

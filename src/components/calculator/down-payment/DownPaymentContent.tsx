  ...
  return (
    <div className="space-y-10 text-slate-800 dark:text-slate-200 font-medium leading-relaxed max-w-4xl mx-auto">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-xs">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-normal">
              Conventional 97 programs require 3% down for first-time buyers with 620+ credit scores. FHA loans require 3.5% down for scores 580+.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-normal">
              The benchmark threshold to completely avoid Private Mortgage Insurance (PMI) on conventional financing and secure lower interest rates.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed">
          While putting 20% down remains the ideal benchmark to eliminate PMI, waiting years to accumulate 20% can cause buyers to miss out on home price appreciation and wealth accumulation.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div className="p-5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900/50 space-y-2">
            ...
            <ul className="list-disc list-inside text-slate-700 dark:text-slate-300 space-y-1 font-normal">
              ...
              <li>Lower lifetime interest expense over 30 years</li>
          ...
          <div className="p-5 rounded-2xl bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 space-y-2">
            ...
            <ul className="list-disc list-inside text-slate-700 dark:text-slate-300 space-y-1 font-normal">
              ...
              <li>Delaying purchase while saving can lead to higher home prices</li>
              <li>Opportunity cost of not investing extra capital in index funds</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-normal">
              When your principal balance drops to 80% of original home value, you have the legal right to submit a written request to your loan servicer to cancel PMI.
            </p>
          </div>
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
            <h3 className="font-extrabold text-blue-600">78% LTV Automatic Lender Termination</h3>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-normal">
              Lenders MUST automatically terminate PMI once your loan balance reaches 78% of original value through scheduled principal payments.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed">
          Over 2,000 state, county, and municipal Down Payment Assistance (DPA) programs exist across the U.S. to help buyers cover upfront cash needs:
        </p>
        <ul className="list-disc list-inside text-xs text-slate-700 dark:text-slate-300 space-y-1 font-medium">
          ...
          <li><strong>Forgivable 2nd Loans:</strong> Zero-interest loans forgiven after living in the home for 3 to 5 years.</li>
          <li><strong>Deferred Payment Loans:</strong> Second liens with 0% interest repaid when the home is sold or refinanced.</li>
        </ul>
      </section>
      ...
      <section className="p-6 rounded-2xl bg-blue-50/70 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/60 space-y-2 text-xs">
        ...
        <p className="text-slate-700 dark:text-slate-300 leading-relaxed font-medium">
          Understanding down payment requirements, PMI drop-off milestones, closing costs, and investment opportunity costs allows buyers to choose the optimal down payment strategy for long-term financial health.
        </p>
      </section>
    </div>
  );

  ...
  return (
    <div className="space-y-8 mt-8">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-slate-900 to-indigo-950 text-white rounded-xl p-6 sm:p-8 shadow-xl space-y-4 border border-blue-800/50">
        <div className="flex items-center gap-3 border-b border-blue-800/60 pb-3">
        ...
        <div className="space-y-3 text-xs leading-relaxed text-blue-100/90 pt-1">
          ...
          <div className="p-3 rounded-lg bg-white/5 border border-white/10 space-y-1 font-mono">
            ...
            <p className="text-emerald-400 font-extrabold text-sm font-sans">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-xs sm:text-sm leading-relaxed">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
              <div className="bg-emerald-50 dark:bg-emerald-950/30 p-3 rounded-lg border border-emerald-200 dark:border-emerald-900/40 text-xs">
                <h4 className="font-bold text-emerald-800 dark:text-emerald-300 mb-1">Normal Wear & Tear (Covered)</h4>
              ...
              <div className="bg-rose-50 dark:bg-rose-950/30 p-3 rounded-lg border border-rose-200 dark:border-rose-900/40 text-xs">
                <h4 className="font-bold text-rose-800 dark:text-rose-300 mb-1">Excess Wear & Tear (Penalty Fees)</h4>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
              ...
              <div className="bg-zinc-50 dark:bg-zinc-950 p-3.5 rounded-lg border border-zinc-200 dark:border-zinc-800">
                <h4 className="font-bold text-xs text-rose-600 dark:text-rose-400 mb-1">Disadvantages of Leasing</h4>
                <ul className="list-disc pl-4 space-y-1 text-[11px] text-zinc-600 dark:text-zinc-400">
      ...
      <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 sm:p-8 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs pt-1">
          ...
          <div className="p-3.5 rounded-xl border border-rose-200 dark:border-rose-900/50 bg-rose-50/30 dark:bg-rose-950/20 space-y-1 col-span-1 sm:col-span-2 lg:col-span-2">
            <h3 className="font-bold text-rose-800 dark:text-rose-300 text-xs">5. Early Termination Return (High Penalty)</h3>

  ...
  return (
    <article className="prose prose-zinc dark:prose-invert max-w-none space-y-8 text-xs leading-relaxed">
          ...
          <table className="w-full text-left border-collapse border border-zinc-200 dark:border-zinc-800 text-[11px]">
            <thead>
              <tr className="bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100">
                ...
                <th className="p-2.5 border border-zinc-200 dark:border-zinc-700 font-bold text-emerald-600 dark:text-emerald-400">Annualized ROI / CAGR</th>
                <th className="p-2.5 border border-zinc-200 dark:border-zinc-700 font-bold text-purple-600 dark:text-purple-400">IRR / XIRR</th>
              </tr>
            </thead>
      ...
      <section className="space-y-3">
        ...
        <div className="bg-rose-50/60 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-900 p-4 rounded-xl space-y-2 text-xs">

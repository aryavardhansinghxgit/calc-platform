  ...
  return (
    <article className="space-y-8 border-t border-zinc-200 pt-6 text-sm leading-relaxed text-zinc-700 dark:border-zinc-800 dark:text-zinc-300">
      ...
      <section className="space-y-3">
        ...
        <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 font-mono text-sm font-bold text-blue-900 dark:border-blue-900/70 dark:bg-blue-950/30 dark:text-blue-200">Percent error = |observed − true| ÷ |true| × 100%</div>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-800 dark:bg-zinc-950"><h3 className="font-bold text-zinc-900 dark:text-zinc-100">Absolute error</h3><p className="mt-1 font-mono text-xs text-blue-700 dark:text-blue-300">|observed − true|</p><p className="mt-1 text-xs">Keeps the original units.</p></div>
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-800 dark:bg-zinc-950"><h3 className="font-bold text-zinc-900 dark:text-zinc-100">Relative error</h3><p className="mt-1 font-mono text-xs text-blue-700 dark:text-blue-300">absolute error ÷ |true|</p><p className="mt-1 text-xs">A unitless proportion.</p></div>
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-3 dark:border-zinc-800 dark:bg-zinc-950"><h3 className="font-bold text-zinc-900 dark:text-zinc-100">Percent error</h3><p className="mt-1 font-mono text-xs text-blue-700 dark:text-blue-300">relative error × 100</p><p className="mt-1 text-xs">The proportion expressed per 100.</p></div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-zinc-200 p-4 dark:border-zinc-800"><h3 className="font-bold text-blue-700 dark:text-blue-300">Basic: exact result</h3><p className="mt-2 text-xs">Observed = 100, true = 100.</p><p className="mt-2 font-mono text-xs">|100 − 100| ÷ 100 × 100 = 0%</p><p className="mt-2 text-xs">An exact match has zero absolute and signed error.</p></div>
          <div className="rounded-xl border border-zinc-200 p-4 dark:border-zinc-800"><h3 className="font-bold text-blue-700 dark:text-blue-300">Intermediate: overestimate</h3><p className="mt-2 text-xs">Observed = 105, true = 100.</p><p className="mt-2 font-mono text-xs">|105 − 100| ÷ 100 × 100 = 5%</p><p className="mt-2 text-xs">The signed error is +5%, so the measurement is 5% above the reference.</p></div>
          <div className="rounded-xl border border-zinc-200 p-4 dark:border-zinc-800"><h3 className="font-bold text-blue-700 dark:text-blue-300">Advanced: negative reference</h3><p className="mt-2 text-xs">Observed = −9.5, true = −9.8.</p><p className="mt-2 font-mono text-xs">0.3 ÷ 9.8 × 100 = 3.061%</p><p className="mt-2 text-xs">The denominator uses the reference magnitude, 9.8. State your sign convention when reporting signed error for negative quantities.</p></div>
        </div>
      </section>

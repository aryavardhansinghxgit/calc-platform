      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-10">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-rose-600">1.</span> What Is Conception?
          </h3>
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-rose-600">2.</span> Difference Between Conception and Fertilization
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
        ...
        <div className="space-y-4 pt-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-rose-600">6–12.</span> Fertile Window, Gamete Physiology & Biomarkers
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
        ...
        <div className="space-y-4 pt-4">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-rose-600">17.</span> Conception Probability by Cycle Timing
          </h3>
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-2">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-center">
              <div className="text-[10px] text-slate-500 font-bold">-5 Days</div>
              <div className="text-lg font-black text-blue-700 mt-1">5%</div>
              <div className="text-[9px] text-slate-500 font-medium">Low</div>
            </div>
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-center">
              <div className="text-[10px] text-slate-500 font-bold">-4 Days</div>
              <div className="text-lg font-black text-blue-800 mt-1">12%</div>
              <div className="text-[9px] text-slate-500 font-medium">Moderate</div>
            </div>
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-center">
              <div className="text-[10px] text-slate-500 font-bold">-3 Days</div>
              <div className="text-lg font-black text-cyan-700 mt-1">18%</div>
              <div className="text-[9px] text-slate-500 font-medium">Moderate</div>
            </div>
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-center">
              <div className="text-[10px] text-slate-500 font-bold">-2 Days</div>
              <div className="text-lg font-black text-emerald-700 mt-1">27%</div>
              <div className="text-[9px] text-slate-500 font-medium">High</div>
            </div>
            <div className="p-3 bg-rose-50 rounded-xl border border-rose-300 text-center scale-105 shadow-xs">
              <div className="text-[10px] text-rose-700 font-bold">-1 Day</div>
              <div className="text-lg font-black text-rose-600 mt-1">33%</div>
              <div className="text-[9px] text-rose-700 font-bold">PEAK</div>
            </div>
            <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-300 text-center scale-105 shadow-xs">
              <div className="text-[10px] text-emerald-700 font-bold">0 Day</div>
              <div className="text-lg font-black text-emerald-600 mt-1">30%</div>
              <div className="text-[9px] text-emerald-700 font-bold">PEAK</div>
            </div>
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-center">
              <div className="text-[10px] text-slate-500 font-bold">+1 Day</div>
              <div className="text-lg font-black text-slate-500 mt-1">5%</div>
              <div className="text-[9px] text-slate-500 font-medium">Low</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 pt-4 border-t border-slate-100">
          <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <span className="text-rose-600">21.</span> IVF & Assisted Reproductive Technology (ART)
          </h3>
          <p className="text-slate-700 leading-relaxed text-sm md:text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs md:text-sm">
            <div className="p-4 bg-slate-50/80 rounded-xl border border-slate-200">
              <div className="font-bold text-rose-700">Day 3 Embryo Transfer</div>
              <div className="text-slate-600 mt-1">Conception Date = Transfer Date - 3 Days</div>
            </div>
            <div className="p-4 bg-slate-50/80 rounded-xl border border-slate-200">
              <div className="font-bold text-purple-700">Day 5 Blastocyst Transfer</div>
              <div className="text-slate-600 mt-1">Conception Date = Transfer Date - 5 Days</div>
            </div>
            <div className="p-4 bg-slate-50/80 rounded-xl border border-slate-200">
              <div className="font-bold text-cyan-700">Estimated Due Date (EDD)</div>
              <div className="text-slate-600 mt-1">Transfer Date + 266 Days - Embryo Age</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-xs text-slate-500 mt-1">Menstrual cycle & period tracker.</p>
          </Link>

...
export const density_calculatorMetadata: Metadata = {
  ...
  alternates: {
    canonical: "https://calcplatform.org/calculators/density-calculator",
  },
  openGraph: {
    ...
    url: "https://calcplatform.org/calculators/density-calculator",
    type: "website",
    images: [
      {
        url: "https://calcplatform.org/og?title=Density%20Calculator",
        width: 1200,
        height: 630,

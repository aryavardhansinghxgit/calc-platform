...
export const molecular_weight_calculatorConfig: CalculatorModuleDefinition = {
  ...
  description:
    "Calculate molar mass from a chemical formula, solve empirical and molecular formulas, and convert between grams, moles and molecules.",
  iconName: "Atom",
  featured: true,
  keywords: [
  ...
  priority: 1,
  relatedCalculators: ["molarity-calculator", "density-calculator", "percentage-calculator"],

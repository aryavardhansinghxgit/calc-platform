...
export const roofing_calculatorConfig: CalculatorModuleDefinition = {
  ...
  description: "Calculate roof surface area, pitch-adjusted square footage, roofing squares, shingle and underlayment quantities, fasteners, and estimated replacement cost. Compare gable, hip, shed, gambrel, mansard, and multi-pitch roof configurations with clear calculations and takeoff-ready results.",
  iconName: "Home",
  featured: true,
